...
export default function App() {
  return (
    <div className="App">
      <div className="image-heading"><img src={bookIcon} className="book-icon book-icon-left" width="250px"/>Dictionary App<img src={bookIcon} className="book-icon book-icon-right" width="250px"/></div>

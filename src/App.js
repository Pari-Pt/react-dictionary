...
export default function App() {
  return (
    <div className="App">
      <div className="MainHeading"><img src={bookIcon} className="BookIcon BookIconLeft" alt="Girl with book" width="250px"/><span className="Title">Dictionary App</span><img src={bookIcon} className="BookIcon BookIconRight"  alt="Girl with book" width="250px"/></div>
